/*
 * drivers/cpufreq/cpufreq_boostedASS2.c
 *
 ...
 * ###boostedASSv2
 * MOTO Devices---uses symsearch.ko
 *
 * fix for 3.0.8 kernel - whirleyes
 * 
 ...
 * also when suspended).
 */
#define DEFAULT_SLEEP_IDEAL_FREQ 196000
...
MODULE_DESCRIPTION ("'cpufreq_boostedASS2' - A smart cpufreq governor\nextra : Moto**** ported version.");
MODULE_LICENSE ("GPL");
